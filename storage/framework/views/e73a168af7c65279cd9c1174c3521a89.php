            ...
            <div class="card border-0 shadow-lg h-100">
                ...
                <div class="card-body d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        <h1 class="fw-bold text-primary"><?php echo e($jumlahPerusahaan); ?></h1>
                    </div>
            ...
            <div class="card border-0 shadow-lg h-100">
                ...
                <div class="card-body d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        <h1 class="fw-bold text-success"><?php echo e($jumlahLowongan); ?></h1>
                    </div>
        ...
        <div class="col-lg-4 mb-4">
            ...
            <div class="card border-0 shadow">
                ...
                <div class="card-body d-grid gap-3">
                    ...
                    <a href="<?php echo e(route('perusahaan.index')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Project_akhir_pemrograman_web\resources\views/dashboard.blade.php ENDPATH**/ ?>